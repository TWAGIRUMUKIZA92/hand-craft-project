                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-30">
                                        <div class="card-body  text-success">
                                            ...
                                            <form  action="<?=base_url()?>Consultator/changePassword" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-lg-6">
                                    <div class="card m-b-30">
                                        <div class="card-body text-warning">
                                            ...
                                            <form  action="<?=base_url()?>Consultator/changeInfo" method="post" enctype="multipart/form-data">
