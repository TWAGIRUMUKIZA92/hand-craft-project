...
<footer class="footer">
	<b>© <?php echo date("Y"); ?>
	Artisan</b> <span class="d-none d-sm-inline-block"> - NYAMASHEKE District</span>
</footer>
...
<script src="<?php echo base_url();?>assets/pages/alertify-init.js"></script>
...
<script src="<?php echo base_url();?>assets/pages/chartist.init.js"></script>
...
<!-- Chat js --->
<script src='<?php echo base_url();?>http://code.jquery.com/jquery-1.11.3.min.js'></script>
