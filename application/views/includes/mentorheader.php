		...
		<div class="sidebar-inner slimscrollleft">
			...
			<div id="sidebar-menu">
				<ul>
					...
					<li>
						<a href="<?php echo base_url();?>Mentor/index" class="waves-effect">
							<i class="mdi mdi-view-dashboard"></i>
							<span> Dashboard </span>
						</a>
					</li>
                    <li>
						<a href="<?php echo base_url(); ?>mentor/myProject" class="waves-effect">
							<i class="mdi mdi-projector-screen  float-left mb-0"></i>
							<span> My Project </span>
						</a>
					</li>
					<li>
						<a href="<?php echo base_url();?>mentor/chat" class="waves-effect">
							<i class="ion-chatbubble-working float-left mb-0"></i>
							<span> Chat </span>
						</a>
					</li>
					...
					<ul class="list-inline float-right mb-0">
						...
						<li class="list-inline-item dropdown notification-list">
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
								...
								<a class="dropdown-item" href="<?php echo base_url()?>mentor/logout"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
							</div>
						</li>
