	...
	<div class="left side-menu">
		...
		<div class="left-side-logo d-block d-lg-none">
			<div class="text-center">
				...
				<a href="<?php echo base_url();?>" class="logo"><img src="<?php echo base_url();?>assets/images/logo-dark.png" height="20" alt="logo"></a>
			</div>
		</div>
		...
		<div class="sidebar-inner slimscrollleft">
			...
			<div id="sidebar-menu">
				<ul>
					...
					<li>
						<a href="<?php echo base_url();?>College/index" class="waves-effect">
					...
					<li class="has_sub">
						<a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-file-document-box"></i> <span> Mentors  </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
						<ul class="list-unstyled">
							<li><a href="<?php echo base_url('College/newMentor');?>"> Mentor Registration</a></li>
							<li><a href="<?php echo base_url('College/mentors');?>">View Mentors</a></li>
							

						</ul>
					</li>
					<li class="has_sub">
						<a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-file-document-box"></i> <span> Innovations  </span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>
						<ul class="list-unstyled">
							<li><a href="<?php echo base_url('College/request');?>"> Innovation Request</a></li>
							<li><a href="<?php echo base_url('College/promote');?>">Promote innovation</a></li>
							<li><a href="<?php echo base_url('College/suspension');?>">Requested suspension</a></li>
							<li><a href="<?php echo base_url('College/report');?>">Innovation Reports</a></li>
						</ul>
					</li>

					<li>
						<a href="<?php echo base_url();?>college/chat" class="waves-effect"><i class="mdi mdi-message-text"></i><span> Forum</span> <span class="badge badge-success badge-pill float-right">3</span></a>
					</li>

					<li>
						<a href="<?php echo base_url('include/help');?>" class="waves-effect">
					...
					<li class="has_sub">
						<a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-settings"></i> <span> Account Settings</span> <span class="menu-arrow float-right"><i class="mdi mdi-chevron-right"></i></span></a>

						<ul class="list-unstyled">
							<li>  <a href="<?php echo base_url('college/setting');?>"><span class="menu-arrow float-left"> <i class="mdi mdi-border-color"></i></span><span>Change Profile</span></a></li>

							<li><a href="<?php echo base_url('college/logout');?>"><span class="menu-" <span class="menu-arrow float-left"><i class="mdi mdi-logout"></i> Logout</span></a></li>
						</ul>
					</li>
			...
			<div class="topbar">
				...
				<div class="topbar-left	d-none d-lg-block">
					<div class="text-center">
						...
						<a href="<?php echo base_url();?>college" class="logo"><img src="<?php echo base_url();?>assets/images/logo.png" height="70" alt="logo"></a>
					</div>
				</div>
				...
				<nav class="navbar-custom">
					...
					<ul class="list-inline float-right mb-0">
						<li class="list-inline-item dropdown d-none d-sm-inline-block ">
							<span class="text-white" style="margin-right: 70px; font-size: medium" >Research & Development MIS</span>
						</li>
						...
						<li class="list-inline-item dropdown notification-list">
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-animated profile-dropdown ">
								...
								<a class="dropdown-item" href="<?php echo base_url('college/setting');?>"><i class="mdi mdi-settings m-r-5 text-muted"></i> Settings</a>
								<a class="dropdown-item" href="#"><i class="mdi mdi-lock-open-outline m-r-5 text-muted"></i> Lock screen</a>
								<a class="dropdown-item" href="<?php echo base_url('college/logout');?>"><i class="mdi mdi-logout m-r-5 text-muted"></i> Logout</a>
							</div>
						</li>
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="float-right page-breadcrumb">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url();?>">R&D</a></li>
