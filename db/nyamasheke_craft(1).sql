...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2022 at 11:01 PM
...
CREATE TABLE `coopaccount_tbl` (
  ...
  `category` varchar(15) NOT NULL DEFAULT 'cooperative',
...
INSERT INTO `coopaccount_tbl` (`coop_id`, `coop_name`, `coop_email`, `coop_pass`, `coop_tel`, `coop_licence`, `category`, `coop_status`, `created_date`) VALUES
(1, 'UBUHANZI RWANDA', 'ubuhanzi250@getrwa.com', 'test@250', '+250780406161', 'xxxxxxxxx', 'cooperative', 1, '2022-06-27 18:40:26'),
(4, '', 'ubuhanzi@getrwa.com', 'test@231', '+250780406161', 'yyyyyy', 'consultator', 1, '2022-06-27 18:34:49');
...
INSERT INTO `craft_tbl` (`crft_id`, `crft_quantity`, `crft_price`, `subtotal`, `crft_img`, `crft_desc`, `cooperative_id`, `registered_date`, `crft_status`) VALUES
(2, 50, 5000, 0, 'assets/uploads/craft/milk9.png', 'Graphic design.', 1, '2022-06-27 10:37:17', 1),
(3, 5, 1000, 0, 'assets/uploads/craft/Nyamasheke_platfoem.PNG', 'Yes,it is working well.', 1, '2022-06-27 10:22:25', 1),
(4, 2, 100, 200, 'xxxxxxx', 'test3', 4, '2022-06-27 10:37:20', 1);
