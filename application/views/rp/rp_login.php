						...
						<div class="card">
							<div class="card-body">
								...
								<h3 class="text-center mt-0 m-b-15">
									<a href="../index.html" class="logo logo-admin"><img src="<?php echo base_url(); ?>assets/images/logo-dark.png" height="30" alt="logo"></a>
								</h3>
								...
								<div class="p-2">
									<form class="form-horizontal m-t-20" name="login" action="" method="post">
